...
def draw_body(canvas, doc) -> None:
    ...
    canvas.drawRightString(width - 19 * mm, height - 11.8 * mm, "v0.5.0-alpha.7 · 21.07.2026")
...
def build(source_path: Path = SOURCE, output_path: Path = OUTPUT) -> Path:
    ...
    story = [
        Spacer(1, 48 * mm),
        Paragraph("ENGINEERING HANDOFF · RELEASE ALPHA.7", style_map["cover_kicker"]),
        ...
        Spacer(1, 25 * mm),
        Table([["RELEASE", "COMMIT", "DATE"], ["v0.5.0-alpha.7", "96b0735", "21.07.2026"]],
