...
Текущий кандидат: **v0.5.0-alpha.38**. До публикации immutable tag используйте branch artifacts только для проверки matching Android + server.

Docker image:

```text
ghcr.io/sereza111/whitelist-bypass-portainer:v0.5.0-alpha.38
```
...
|---|---|
| `WLB_IMAGE` | `ghcr.io/sereza111/whitelist-bypass-portainer:v0.5.0-alpha.38` |
...
```text
[build] version=0.5.0-alpha.38 commit=... built=...
```
