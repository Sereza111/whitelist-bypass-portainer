...
Текущий кандидат: **v0.5.0-alpha.21**. Последний опубликованный релиз: **[v0.5.0-alpha.20](https://github.com/Sereza111/whitelist-bypass-portainer/releases/tag/v0.5.0-alpha.20)**.

Docker image:

```text
ghcr.io/sereza111/whitelist-bypass-portainer:v0.5.0-alpha.21
```
...
- [Примечания alpha.21](docs/ALPHA21_RELEASE_NOTES.md),
...
```text
[build] version=0.5.0-alpha.21 commit=... built=...
```
