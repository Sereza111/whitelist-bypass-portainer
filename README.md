...
Текущий кандидат: **v0.5.0-alpha.35**. До публикации immutable tag используйте branch artifacts только для проверки matching Android + server.

Docker image:

```text
ghcr.io/sereza111/whitelist-bypass-portainer:v0.5.0-alpha.35
```
...
|---|---|
| `WLB_IMAGE` | `ghcr.io/sereza111/whitelist-bypass-portainer:v0.5.0-alpha.35` |
...
```text
[build] version=0.5.0-alpha.35 commit=... built=...
```
