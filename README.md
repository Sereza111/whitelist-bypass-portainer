...
Android, Electron, iOS и готовые мобильные бинарники удалены: они не участвуют
в сборке серверного контейнера. Благодаря этому репозиторий занимает меньше
1 МБ вместо примерно 53 МБ полного snapshot.
